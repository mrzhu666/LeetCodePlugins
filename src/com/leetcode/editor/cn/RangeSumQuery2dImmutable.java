...
// 
// Related Topics 设计 数组 矩阵 前缀和 👍 333 👎 0
...
public class RangeSumQuery2dImmutable{
  public static void main(String[] args) {
    NumMatrix solution = new RangeSumQuery2dImmutable().new NumMatrix(new int[][]{{-4,-5}});
    System.out.print(solution.sumRegion(0,0,0,0));
    System.out.print(solution.sumRegion(0,0,0,1));
    System.out.print(solution.sumRegion(0,0,0,0));
    System.out.print(solution.sumRegion(0,0,0,0));
  }
